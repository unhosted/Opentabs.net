define(
  ...
  function (platform) {
    ...
    (function() {
      var surfnet= {
        api: 'simple',
        //authPrefix: 'https://storage.surfnetlabs.nl/remoteStorage/oauth/authorize?user_address=',
        authPrefix: 'http://lamp.unhosted.org/phpvoot/oauth/authorize?user_address=',
        templatePrefix: 'http://lamp.unhosted.org/storage/'
      };
      var dutchUniversities= ['leidenuniv.nl', 'leiden.edu', 'uva.nl', 'vu.nl', 'eur.nl', 'maastrichtuniversity.nl',
        ...
        'wageningenuniversity.nl', 'ou.nl', 'lumc.nl', 'amc.nl', 'unhosted.org'];
